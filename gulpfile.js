...
var path = {
    ...
    watch: {
        ...
        js:    [
            'assets/src/js/**/*.js',
            'assets/src/bower_components/bootstrap-table/dist/bootstrap-table.js'
        ],
...
gulp.task('watch', function() {
    ...
    gulp.watch(path.watch.img, ['data:build']);
});
